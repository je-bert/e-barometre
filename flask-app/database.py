...
def run_seeds(file_name = 'seeds.xlsx'):
  ...
  from models import Survey, Category, User, Choice, Question, Label, LabelItem, Answer, CustomAnswer, ResetPasswordToken,  Invoice, Report,Section, Barometer, Theme, Behavior, BarometerItem
  if app_context != None:
    with app_context:
      ...
      for model in [Survey, Category, User, Choice, Question, Label, LabelItem, Answer, CustomAnswer, Invoice, Report,Section, Barometer, Theme, Behavior, BarometerItem]:
