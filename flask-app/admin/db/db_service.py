...
from models import Survey, Category, User, Choice, Question, Label, LabelItem, Answer, CustomAnswer, ResetPasswordToken,Section, Barometer, Behavior, Theme, BarometerItem 
import pandas as pd
...
def export_db():
  ...
  with db.engine.connect() as conn:
    with pd.ExcelWriter(file_name) as writer:
          ...
          for model in [Survey, Category, User, Choice, Question, Label, LabelItem, Answer, CustomAnswer, ResetPasswordToken, Section, Barometer, Behavior, Theme, BarometerItem ]:
