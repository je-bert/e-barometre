...
@Component({
  ...
  template: `
    <div class="view show p-0 p-md-5 tw-bg-white">
      <h2>Connexion</h2>

      <p class="mt-3 mb-4">
        Veuillez entrer votre adresse courriel et votre mot de passe afin de
        vous connecter.
      </p>
      <form
        #loginForm="ngForm"
    ...
    <div class="border-top text-center mt-4 pt-2">
      <p class="pt-3 mb-0 text-center">
        ...
        <a routerLink="/auth/signup" class="fw-medium tw-text-primary"
          >Inscrivez-vous</a
        >
      </p>
    </div>
