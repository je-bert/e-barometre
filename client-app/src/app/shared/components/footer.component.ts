      ...
      >
        <ul class="list-inline fs-sm mb-3 order-md-2">
          <li class="list-inline-item my-1">
            <a class="nav-link-style nav-link-light">Aide</a>
          </li>
          <li class="list-inline-item my-1">
            <a class="nav-link-style nav-link-light">Conditions d'utlisation</a>
          </li>
          <li class="list-inline-item my-1">
            <a class="nav-link-style nav-link-light">Avis légal </a>
          </li>

          <li class="list-inline-item my-1">
            <a class="nav-link-style nav-link-light">Tests</a>
          </li>
