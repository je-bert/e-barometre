...
<section class="tw-pt-8 tw-pb-2 tw-z-50">
    <div class="container">
      <div class="row">
        <div class="col-1"></div>
        <div class="col-11 tw-flex tw-justify-end">
          <div class="tw-h-[300px]">
            ...
            <svg
              ...
              style="
                enable-background: new 0 0 885.9 622.8;
                width: 100%;
                height: 100%;
              "
              xml:space="preserve"
              id="questionnaire-bottom-img"
            >
              <style type="text/css">
                #questionnaire-bottom-img .st0 {
                  fill: #3f3d56;
                }

                #questionnaire-bottom-img .st2 {
                  opacity: 0.2;
                  enable-background: new;
                }
                #questionnaire-bottom-img .st3 {
                  fill: #e6e6e6;
                }
                #questionnaire-bottom-img .st4 {
                  fill: #e6e6e6;
                }
                #questionnaire-bottom-img .st5 {
                  fill: #e6e6e6;
                }
                #questionnaire-bottom-img .st6 {
                  fill: #112485;
                }
                #questionnaire-bottom-img .st7 {
                  fill: #e6e6e6;
                }
                #questionnaire-bottom-img .st8 {
                  fill: #ffffff;
                }
              </style>
              <polygon
                class="st0"
                points="461.6,348.4 400.4,348.4 400.4,350.3 410,350.3 410,369.1 411.9,369.1 411.9,350.3 449.1,350.3 
	449.1,369.1 451.1,369.1 451.1,350.3 461.6,350.3 "
              ...
              <circle
                [style.fill]="
                  getCurrentCircleToFill() === 0 ? '#e2725a' : '#e6e6e6'
                "
                class="st1"
                cx="161.4"
                cy="161.4"
              ...
              <path
                class="st2"
                d="M281.4,53.6c35,81.9-3,176.8-84.9,211.8c-63.8,27.3-137.8,10.7-183.9-41c35,81.9,129.9,120,211.8,85
	s120-129.9,85-211.8C302.4,81.5,293,66.6,281.4,53.6z"
              ...
              <circle
                [style.fill]="
                  getCurrentCircleToFill() === 1 ? '#d39c22' : '#e6e6e6'
                "
                class="st3"
                cx="755.3"
                cy="229.8"
              ...
              <path
                class="st2"
                d="M852.4,142.6c28.4,66.3-2.4,143.1-68.8,171.4c-51.6,22.1-111.5,8.7-148.9-33.2c28.4,66.3,105.1,97.1,171.4,68.8
	s97.1-105.1,68.8-171.4C869.4,165.1,861.8,153.1,852.4,142.6z"
              ...
              <circle
                [style.fill]="
                  getCurrentCircleToFill() === 3 ? '#759693' : '#e6e6e6'
                "
                class="st4"
                cx="369.9"
                cy="321.7"
              ...
              <path
                class="st2"
                d="M385.2,308c4.5,10.4-0.4,22.5-10.8,27c-8.1,3.5-17.6,1.4-23.4-5.2c4.5,10.4,16.5,15.3,27,10.8
	c10.4-4.5,15.3-16.5,10.8-27C387.9,311.5,386.7,309.6,385.2,308z"
              ...
              <ellipse
                [style.fill]="
                  getCurrentCircleToFill() === 2 ? '#2d6266' : '#e6e6e6'
                "
              ...
              <path
                class="st2"
                d="M599,220.3c11.4,26.7-1,57.7-27.7,69.1c-20.8,8.9-44.9,3.5-60-13.4c11.4,26.7,42.4,39.1,69.1,27.7
	...
	L123,622.5z"
              ...
              <path
                class="st8"
                d="M476.1,612.1l-1.2-1.6c3.2-2.4,6.4-4.9,9.5-7.3l1.2,1.6C482.6,607.2,479.4,609.7,476.1,612.1z M494.9,597.2
	...
	C467.7,372.8,463.8,373.5,460,374.1z"
              ...
              <path
                class="st0"
                d="M528.1,167.1l9.1-7.3c-7.1-0.8-10,3.1-11.1,6.1c-5.5-2.3-11.5,0.7-11.5,0.7l18.2,6.6
	C531.8,170.8,530.2,168.7,528.1,167.1z"
              />
              <path
                class="st0"
                d="M359.4,223.4l9.1-7.3c-7.1-0.8-10,3.1-11.1,6.1c-5.5-2.3-11.5,0.7-11.5,0.7l18.2,6.6
	C363.1,227.1,361.5,224.9,359.4,223.4z"
              />
              <path
                class="st0"
                d="M403.8,106.9l9.1-7.3c-7.1-0.8-10,3.1-11.1,6.1c-5.5-2.3-11.5,0.7-11.5,0.7l18.2,6.6
